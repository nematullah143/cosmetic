function Footer() {
    return (
        <footer className="bg-navcolor text-black py-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <ul>
                            ...
                            <li><a href="#" className="text-gray-400 hover:text-pink-500">Careers</a></li>
                    ...
                    <div>
                        ...
                        <ul>
                            <li><a href="#" className="text-gray-400 hover:text-pink-500">Contact</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-pink-500">Returns</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-pink-500">Shipping Info</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="font-bold text-lg">Follow Us</h3>
                        <ul className="flex space-x-4">
                            <li><a href="#" className="text-gray-400 hover:text-pink-500">Facebook</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-pink-500">Instagram</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-pink-500">Twitter</a></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <button type="submit" className="bg-pink-500 text-white w-full mt-2 p-2">Subscribe</button>
                        </form>
                    </div>
                </div>
                <div className="text-center mt-8">
                    <p className="text-gray-400">© 2025 logo Beauty. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    )
